...
public class QuoteAndPictureService {
    ...
    private static final String IMAGE_API_URL = "https://thatcopy.pw/catapi/rest/";
    ...
    public QuoteAndPicture getQuoteAndPicture() {
        ...
        return new QuoteAndPicture(quote != null ? quote.getQuote() : "", picture != null ? picture.getUrl() : "");
    }
}
